...
class TAThemeDistributionTable{
     ...
     * @private
     * @instance
     * @description to calculate count, %top boxes, values% and stdev we use statistics header, data is filtered by scale mast in rowheaders
