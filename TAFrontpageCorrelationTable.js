/**
 * @class TAFrontpageCorrelationTable
 * @classdesc Class to work with Correlation table for Frontpage
 *
 * @constructs TAFrontpageCorrelationTable
 * @param {Object} params - {
...
class TAFrontpageCorrelationTable{
    ...
    private var _showOwnCategory;
    private var _currentLanguage;
    private var _curDictionary;

    function TAFrontpageCorrelationTable(params){
        ...
        _showOwnCategory = params.showOwnCategory;
    ...
    private function _getRowheadersExpression(){
        ...
        if (_selectedCategory != "all") {
            ...
            if (chMask.length > 0 && !_showOwnCategory) {
                mask = chMask;
            } else {
